...
# device
$(call inherit-product-if-exists, device/asus/tilapia/full_tilapia.mk)
...
PRODUCT_NAME := ukg_tilapia
PRODUCT_MODEL := Nexus 7
PRODUCT_MANUFACTURER := Asus
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.tilapia.$(shell date +%m%d%y).$(shell date +%H%M%S)
